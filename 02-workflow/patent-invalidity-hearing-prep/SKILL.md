---
name: patent-invalidity-hearing-prep
description: 用于中国专利无效案件的案卷梳理、程序时间线整理、攻击与答辩框架提炼、口审前焦点归纳、口头审理准备文件分步起草、临场备答和 Word 导出。 当用户要做无效过程梳理、案卷梳理、口审准备、开庭陈述、正式抗辩、请求人可能观点短答、审查员追问备答或将口审准备文件导出为 Word 时，都使用这一个 skill。
---
...
这是无效案件梳理和口审准备的唯一公开入口。不要再把“无效过程梳理”和“口审准备”拆成多个公开 skill。
